...
static int dumpPositionsCb(void *cnxt __attribute__((unused)), u4 address, u4 lineNum)
{
...
static void dumpLocalsCb(void *cnxt __attribute__((unused)), u2 reg, u4 startAddress,
